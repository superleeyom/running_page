// const
const MAPBOX_TOKEN = 'pk.eyJ1IjoibGVleW9tIiwiYSI6ImNraDl2YjRxbDBhdWsyd28xYTFpZW9hNXUifQ.ofXQvmske-p2YeNzZV10Kg';
...
const CHINESE_INFO_MESSAGE = (yearLength, year) => `我用 Apple Watch 记录自己跑步 ${yearLength} 年了，下面列表展示的是${year === 'Total' ? '所有' : ' ' + year + ' '}的数据`;
